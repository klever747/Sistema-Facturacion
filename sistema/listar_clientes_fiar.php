    ...
    <body>
       <?PHP
        ...
        <section id="container">
            <h1> <i class="fas fa-users fa-2x"></i> Lista de clientes Fiadores</h1>
            ...
            <table>
                ...
                $sql_registe = mysqli_query($conexion,"SELECT count(*) as total_registro FROM cliente WHERE estatus=1 AND idtipo=2");
                ...
                $query = mysqli_query($conexion, "SELECT * FROM cliente WHERE estatus = 1 AND idtipo=2 ORDER BY  idcliente ASC LIMIT $desde,$por_pagina ");
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                |
                                <a class="link_add datosCliente" href="#" idCliente ="<?PHP echo $data["idcliente"]; ?>"  > <i class="fas fa-plus"></i>  Pagar</a>
