...
if (empty($_REQUEST['cl']) || empty($_REQUEST['f'])) {
    ...
    if ($noFactura !='010101') {
        ...
        if ($result > 0) {
            ...
            $saldoAnterior = mysqli_query($conexion, "SELECT saldoFactura from saldo_factura_cliente WHERE (idcliente = $codCliente)");
            ...
            $ar = array(
                ...
                "cantidad"=>'-',
                "precio_venta" =>"-",
                "precio_total"=>$respSaldoAnt
            );
            $result_detalle = sizeof($ar);
            //$result_detalle = mysqli_num_rows($query_productos);
