	...
	<table id="factura_head">
		<tr>
			<td class="logo_factura">
				<div>
                                    <img src="img/tienda.PNG" style="width: 200px;height: 200px">
				</div>
			</td>
			 ...
			 ?>
				<tr>
					...
					<td><?php echo $row['descripcion']; ?></td>
                                        <td class="textright"><?php echo round($row['precio_venta'],2); ?></td>
                                        <td class="textright"><?php echo round($row['precio_total'],2); ?></td>
				</tr>
			<?php
